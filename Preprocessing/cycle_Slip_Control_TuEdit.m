...
function [rnxdata]=cycle_Slip_Control_TuEdit(clockdata, clocktime, sp3data, sp3time,rnxdata,rnxzaman,recPosition1,rnx_GPS,rnx_GLO,rnx_GAL,rnx_BDS,rnx_QZSS,elev_cut,Smooth)

disp('Turbo Edit algorithm')
...
if rnx_GPS.GPS_system==1 && ~isempty(sp3data.GPS)
    ...
    disp('Cycle slip is being searched in GPS observations with Turbo Edit Algorithm...')
    ...
    for satNum=1:size(rnxdata.GPS{2,1},2)
        if ~isempty(rmmissing(rnxdata.GPS{2,rnx_GPS.L2columnGPS}(:,satNum))) && ~isempty(rmmissing(rnxdata.GPS{2,rnx_GPS.L1columnGPS}(:,satNum)))
            ...
            [rnxdata]=cycle_slip_Det_Repair_TuEdit(clockdata, clocktime, sp3data, sp3time,rnx_GPS.L1columnGPS,rnx_GPS.L2columnGPS,rnx_GPS.C1columnGPS,rnx_GPS.C2columnGPS,rnxdata,rnxzaman,recPosition1,elev_cut,1,Smooth,satNum);
...
if rnx_GLO.GLO_system==1 && ~isempty(sp3data.GLONASS)
    ...
    disp('Cycle slip is being searched in GLONASS observations with Turbo Edit Algorithm...')
    ...
    for satNum=1:size(rnxdata.GLONASS{2,1},2)
        if ~isempty(rmmissing(rnxdata.GLONASS{2,rnx_GLO.L2columnGLO}(:,satNum))) &&  ~isempty(rmmissing(rnxdata.GLONASS{2,rnx_GLO.L1columnGLO}(:,satNum)))
            ...
            [rnxdata]=cycle_slip_Det_Repair_TuEdit(clockdata, clocktime, sp3data, sp3time,rnx_GLO.L1columnGLO,rnx_GLO.L2columnGLO,rnx_GLO.C1columnGLO,rnx_GLO.C2columnGLO,rnxdata,rnxzaman,recPosition1,elev_cut,2,Smooth,satNum);
        else
...
if rnx_GAL.GAL_system==1 && ~isempty(sp3data.GALILEO)
    ...
    disp('Cycle slip is being searched in Galileo observations with Turbo Edit Algorithm...')
    for satNum=1:size(rnxdata.GALILEO{2,1},2)
        if ~isempty(rmmissing(rnxdata.GALILEO{2,rnx_GAL.L2columnGAL}(:,satNum))) && ~isempty(rmmissing(rnxdata.GALILEO{2,rnx_GAL.L1columnGAL}(:,satNum)))
            ...
            [rnxdata]=cycle_slip_Det_Repair_TuEdit(clockdata, clocktime, sp3data, sp3time,rnx_GAL.L1columnGAL,rnx_GAL.L2columnGAL,rnx_GAL.C1columnGAL,rnx_GAL.C2columnGAL,rnxdata,rnxzaman,recPosition1,elev_cut,3,Smooth,satNum);
...
if rnx_BDS.BDS_system==1 && ~isempty(sp3data.BEIDOU)
    ...
    disp('Cycle slip is being searched in BDS observations with Turbo Edit Algorithm...')
    for satNum=1:size(rnxdata.BEIDOU{2,1},2)
        if ~isempty(rmmissing(rnxdata.BEIDOU{2,rnx_BDS.L2columnBDS}(:,satNum))) &&  ~isempty(rmmissing(rnxdata.BEIDOU{2,rnx_BDS.L1columnBDS}(:,satNum)))
            ...
            [rnxdata]=cycle_slip_Det_Repair_TuEdit(clockdata, clocktime, sp3data, sp3time,rnx_BDS.L1columnBDS,rnx_BDS.L2columnBDS,rnx_BDS.C1columnBDS,rnx_BDS.C2columnBDS,rnxdata,rnxzaman,recPosition1,elev_cut,4,Smooth,satNum);
        else
...
if rnx_QZSS.QZSS_system==1 && ~isempty(sp3data.QZSS)
    ...
    disp('Cycle slip is being searched in QZSS observations with Turbo Edit Algorithm...')
    for satNum=1:size(rnxdata.QZSS{2,1},2)
        if ~isempty(rmmissing(rnxdata.QZSS{2,rnx_QZSS.L2columnQZSS}(:,satNum)))  && ~isempty(rmmissing(rnxdata.QZSS{2,rnx_QZSS.L1columnQZSS}(:,satNum)))
            ...
            [rnxdata]=cycle_slip_Det_Repair_TuEdit(clockdata, clocktime, sp3data, sp3time,rnx_QZSS.L1columnQZSS,rnx_QZSS.L2columnQZSS,rnx_QZSS.C1columnQZSS,rnx_QZSS.C2columnQZSS,rnxdata,rnxzaman,recPosition1,elev_cut,5,Smooth,satNum);
        else
