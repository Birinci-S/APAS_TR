%function [C1columnGAL, C2columnGAL, L1columnGAL,L2columnGAL, GAL_C1, GAL_C2,GAL_L1,GAL_L2]=signals_GAL(rnxdata)
function [rnx_GAL]=signals_GAL_v2(rnxdata)
...
if isfield(rnxdata, 'GALILEO')
    ...
    if ~isempty(find(1==contains(rnxdata.GLONASS(1,:),'C1'), 1))
        GAL_C1='C1';
        C1columnGAL=(find(1==contains(rnxdata.GLONASS(1,:),'C1'), 1));
        SNR1columnGAL=(find(1==contains(rnxdata.GALILEO(1,:),'S1'), 1));
    ...
    if ~isempty(find(1==contains(rnxdata.GLONASS(1,:),'C5'), 1))
        GAL_C2='C5';
        C2columnGAL=(find(1==contains(rnxdata.GLONASS(1,:),'C5'), 1));
        SNR2columnGAL=(find(1==contains(rnxdata.GALILEO(1,:),'S5'), 1));
    ...
    if ~isempty(find(1==contains(rnxdata.GLONASS(1,:),'L1'), 1))
        GAL_L1='L1';
        L1columnGAL=(find(1==contains(rnxdata.GLONASS(1,:),'L1'), 1));
    ...
    if ~isempty(find(1==contains(rnxdata.GLONASS(1,:),'L5'), 1))
        GAL_L2='L5';
        L2columnGAL=(find(1==contains(rnxdata.GLONASS(1,:),'L5'), 1));
